...
= 3.1 =
* Fixed bug with displaying comments count
* Fixed PHP warnings on image processing
* Code cleanup and optimization
* Upgrade version to 3.1 - tested on WP 6.9
...
* Refactoring code in header file
* Added internationalization to placeholder file
