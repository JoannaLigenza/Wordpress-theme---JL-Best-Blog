                ...
                if (get_theme_mod( 'footer-social-icon' )) { ?>
                    ...
                    if (get_theme_mod( 'social-icon-facebook' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-facebook' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/facebook-icon.png' ?>" alt="facebook-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- instagram icon -->
                    ...
                    if (get_theme_mod( 'social-icon-instagram' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-instagram' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/instagram-icon.png' ?>" alt="instagram-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- twitter icon -->
                    ...
                    if (get_theme_mod( 'social-icon-twitter' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-twitter' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/twitter-icon.png' ?>" alt="twitter-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- pinterest icon -->
                    ...
                    if (get_theme_mod( 'social-icon-pinterest' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-pinterest' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/pinterest-icon.png' ?>" alt="pinterest-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- youtube icon -->
                    ...
                    if (get_theme_mod( 'social-icon-youtube' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-youtube' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/youtube-icon.png' ?>" alt="youtube-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- whatsapp icon -->
                    ...
                    if (get_theme_mod( 'social-icon-whatsapp' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-whatsapp' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/whatsapp-icon.png' ?>" alt="whatsapp-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- messenger icon -->
                    ...
                    if (get_theme_mod( 'social-icon-messenger' ) !== "") { ?>
                        <a href="<?php echo get_theme_mod( 'social-icon-messenger' ) ?>">
                            <img src="<?php echo get_theme_file_uri() . '/images/messenger-icon.png' ?>" alt="messenger-icon" class="social-icon">
                        </a>
                    <?php
                    } ?>
                    <!-- linkedin icon -->
