                ...
                <div class="footer-links-container">
                    ...
                    if ( get_theme_mod( 'footer-privacy-policy') ) {
                        ...
                        if( $privacy_policy_page ) : ?>
                            <p><?php echo _e( 'Read our ', 'jl-best-blog' ) ?><a href="<?php echo esc_url( get_permalink( $privacy_policy_page ) ) ?>" class='privacy-policy-link'> <?php _e( 'Privacy Policy', 'jl-best-blog' ) ?> </a></p>
                        <?php endif;
                    } ?>
                    <p class="footer-link"><small><?php _e( 'Theme made by: ', 'jl-best-blog') ?></small><a href="<?php echo esc_url( 'https://love-coding.pl/en' ); ?>" class="footer-theme-link">JL</a><small>, 
                    <?php _e( 'to: ', 'jl-best-blog') ?> <a href="<?php echo esc_url( home_url() ); ?>" class="footer-theme-link"><?php echo bloginfo('name') ?></a></small></p>
                </div>
            </div>
